...
We create a random forest to be used as a basis to predict diagnosis.  The forest is set up so that there will be 500 trees and 3 variables will be tried at each split.
