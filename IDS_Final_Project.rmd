...
# 3. Build a classification algorithm using decision trees. Prune your tree appropriately.
...
# 5. Build a classification algorithm using random forests/bagging. Adjust the parameters of
...
confusion_1 <- table(diag_knn_9, testing$diagnosis)
confusion_1
...
cat("\n*** Option 2 ***\n")
# create and display the confusion matrix
confusionMatrix(factor(diag_knn_9),factor(testing$diagnosis))
```
